...
# PCA PLOTTING
# ------------------------------------------------------------
def plot_parameter_space_pca(df_params, df_states, random_state):
    """Scaling, PCA dimensionality reduction and interactive plotting."""
    ...
    # PARAMETER SPACE PLOT (PCA Projection)
    ...
    plt.title("Parameter Space Mapping (PCA)")
...
def main():
    ...
    plot_parameter_space_pca(df_params=df_params, df_states=df_states, random_state=RANDOM_STATE)
